			...
			function F() {
				...
				Node.prototype.use = function (data, activate, reactive) {
					...
					if (me instanceof HTMLElement) {
						...
						try {
							for (var _iterator = me.childNodes[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
						...
						try {
							for (var _iterator2 = children[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
								...
								_child.use(data, activate, reactive);
							}
						} catch (err) {
						...
						try {
							for (var _iterator3 = me.attributes[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
				...
				Object.defineProperty(fete, "popHandler", { writable: true, configurable: true, value: function value(event) {
						...
						for (var _i2 = 0; _i2 < _arr.length; _i2++) {
							var key = _arr[_i2];event.target[key] = parser[key];
						}fete.router(event);
					} });
				...
				for (var _i3 = 0; _i3 < _arr2.length; _i3++) {
					var type = _arr2[_i3];document.addEventListener(type, onchange);
				}
			}
			...
			_createClass(F, [{
								...
								!reactive || reactive.forEach(function (view) {
									...
									if (interpolator) {
										...
										if (view instanceof Attr && node) {
											...
											try {
												for (var _iterator4 = parent.childNodes[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
				...
				value: function compile(view) {
					...
					if (view instanceof HTMLElement) {
						...
						try {
							for (var _iterator5 = view.childNodes[Symbol.iterator](), _step5; !(_iteratorNormalCompletion5 = (_step5 = _iterator5.next()).done); _iteratorNormalCompletion5 = true) {
						...
						try {
							for (var _iterator7 = view.attributes[Symbol.iterator](), _step7; !(_iteratorNormalCompletion7 = (_step7 = _iterator7.next()).done); _iteratorNormalCompletion7 = true) {
								var attribute = _step7.value;
								me.compile(attribute);
							}
						} catch (err) {
